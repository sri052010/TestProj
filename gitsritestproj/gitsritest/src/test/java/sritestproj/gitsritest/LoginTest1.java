...
public class LoginTest1 {
  ...
  public void f() throws InterruptedException {
	  Thread.sleep(1000);
	  driver.findElement(By.xpath("//input[contains(@type,'text')]")).sendKeys("latest hollywood movies");
	  //Thread.sleep(500);
	 ...
	 // try
	 // {
	   wb1 = driver.findElement(By.xpath("//a[@name='etimeshomelink'][contains(text(),'The Times of India')]")).isDisplayed();
	//  }
	//  catch(Exception e)
	 // {
	//	  wb1=false;
